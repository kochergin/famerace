...
function renderSvg(content: CardContent): string {
  ...
  ${statBlocks}
  <!-- brand: NOVA — the rising star with a comet trail -->
  <g transform="translate(72 ${H - 100}) scale(0.5)">
    <path fill="${COLORS.lime}" d="M14,94 Q47,76 59,49 Q55,71 41,84 Q29,91 14,94 Z"/>
    <path fill="${COLORS.lime}" d="M66,13 L74,32 L87,40 L74,48 L66,67 L58,48 L45,40 L58,32 Z"/>
  </g>
